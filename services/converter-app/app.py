...
stripe.api_key = os.getenv("STRIPE_KEY",'sk_test_51Rb6QxQPcChcTzeTPzUYiycboDEIVG0rPfyO8zkg43YayONKFFXnW6lapghxQgmnSOQCuSkdUHtekSwI3EJ9zvFt00xNgfbAQn')
...
endpoint_secret=os.getenv("ENDPOINT_SECRET",None)
