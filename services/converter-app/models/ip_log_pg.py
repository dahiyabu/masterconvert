...
POSTGRES_DSN = os.getenv("POSTGRES_DSN", "dbname=cm_dev user=dev_giloy_owner password=kLhcRC7v2Epq  host=ep-white-queen-a6lt09cn.us-west-2.aws.neon.tech port=5432")
